...
if __name__ == '__main__':
    ...
    mc_wn_file = join(dir_results,'TrES_3b_white_wn_fld_mc.npz')
    mc_gp_file = join(dir_results,'TrES_3b_white_gp_fld_mc.npz')

    de_file = join(dir_results,'TrES_3b_white_de.npz')
    mc_file = join(dir_results,'TrES_3b_white_{:s}_fld_mc.npz').format(args.noise_model)
